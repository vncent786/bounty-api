    ...
    <section class="zone" aria-labelledby="known-research-title">
      ...
      <div class="known-topic-layout">
        ...
        <div class="research-brief-grid">
          ...
          <fieldset class="source-picker research-topics" id="direct-source-picker"><legend>Research sources</legend><div class="source-options"><label><input id="direct-source-reddit" type="checkbox" value="reddit" checked>Reddit</label><label><input id="direct-source-youtube" type="checkbox" value="youtube" checked>YouTube</label><label><input id="direct-source-instagram" type="checkbox" value="instagram">Instagram</label><label><input id="direct-source-tiktok" type="checkbox" value="tiktok">TikTok</label></div><p>Reddit and YouTube are selected by default. Instagram and TikTok remain optional while hosted access is being repaired.</p></fieldset>
    ...
    <section class="zone" aria-labelledby="live-scan-title">
      ...
      <section class="live-topics" aria-labelledby="live-topics-title">
        ...
        <div class="result-controls">
          ...
          <fieldset class="source-picker" id="trend-source-picker"><legend>Research sources</legend><div class="source-options"><label><input id="trend-source-reddit" type="checkbox" value="reddit" checked>Reddit</label><label><input id="trend-source-youtube" type="checkbox" value="youtube" checked>YouTube</label><label><input id="trend-source-instagram" type="checkbox" value="instagram">Instagram</label><label><input id="trend-source-tiktok" type="checkbox" value="tiktok">TikTok</label></div><p>Reddit and YouTube are selected by default. Instagram and TikTok remain optional while hosted access is being repaired.</p></fieldset>
        </div>
        <div class="live-topics-split">
          ...
          <section id="explore-detail" class="detail-pane evidence-sheet-pane" aria-live="polite"><div class="empty compact"><p class="eyebrow">Search signal</p><h2>Select a topic</h2><p>Inspect its search signal and related queries. Public evidence appears only after a research run.</p></div></section>
        </div>
      </section>
    </section>
